...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\PsychoPy Miltner\\English\\Miltner1999 - Pain Threshold_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Instr_text = visual.TextStim(win=win, name='Instr_text',
        text='Welcome, and thank you for participating in this experiment. \nWe will now calibrate the intensity of the electrical stimuli.\n\nYou will experience a series of stimuli. For each sensation, \nplease indicate how painful you perceive it using the following scale:\n\n--- Press the space bar to continue ---',
        font='Arial',
    ...
    pain_slider = visual.Slider(win=win, name='pain_slider',
        startValue=None, size=(1.0, 0.05), pos=(0, -0.15), units=win.units,
