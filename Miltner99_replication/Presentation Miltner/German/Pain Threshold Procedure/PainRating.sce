...
picture {
	text { caption = "Bitte die Schmerzstärke einschätzen (verbal):"; font_size = 24; font_color = 255,255,255; }; x = 0; y = 160;
...
trial {
	...
	picture {
		text { caption = "Willkommen und vielen Dank für Ihre Teilnahme an diesem Experiment. 
Wir werden nun die Intensität der elektrischen Reize kalibrieren."; font_size = 24; font_color = 255,255,255;}; x = 0; y = 140;
		text { caption = "Sie werden eine Reihe von Reizen erleben.
Bitte geben Sie für jede Empfindung an, wie schmerzhaft Sie diese empfinden. Verwenden Sie dabei die folgende Skala:"; font_size = 24; font_color = 255,255,255;}; x = 0; y = 0;
	} ;
} instruction_trial;
...
term.print( "Drücke Leertaste zum Starten\n");
...
begin
	...
	term.print("Rating abwarten - weiter mit S\n");	
