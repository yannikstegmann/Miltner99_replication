...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\Experimente\\Experiment - EEGManylabs - Miltner1999\\PsychoPy Miltner\\English\\Miltner1999_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Instr_text = visual.TextStim(win=win, name='Instr_text',
        text='Welcome and thank you for participating in this experiment.\n\n\n--- Press the space bar to continue ---',
        font='Arial',
    ...
    instr_2_text = visual.TextStim(win=win, name='instr_2_text',
        text='For the next 30 minutes you will see different symbols.\nYour task is to focus on the fixation cross in the centre of the screen.\n\n---  Press the space bar to continue  ---',
        font='Arial',
        pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
        color='white', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    instr_3_text = visual.TextStim(win=win, name='instr_3_text',
        text="In between, you should regularly indicate how you feel while seeing these stimuli.\nThere are no 'right' or 'wrong' answers, so please answer as honestly as possible!\n\n\n---  Press the space bar to continue  ---",
        font='Arial',
        pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
        color='white', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    practice_text = visual.TextStim(win=win, name='practice_text',
        text='The scale ranges from negative to positive.\nAt the first extreme, the stimuli have a very negative effect on you, at the other a very positive effect.\nIf the stimuli have no effect on you, i.e. neither positive nor negative, move the marker to the centre.\n\nUse the arrow keys to place the blue marker on the corresponding number.\nPress "Enter" to confirm your selection and continue with the experiment.',
        font='Arial',
        pos=(0, 0.1), height=0.04, wrapWidth=1.1, ori=0, 
        color='white', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
        depth=0.0);
    practice_slider = visual.RatingScale(win=win, name='practice_slider', marker='triangle', size=1.0, pos=[0.0, -0.65], low=-4, high=4, labels=['very negative', ' neutral', ' very positive'], scale='How negative/positive do you feel while seeing this stimulus?', markerStart='0', showAccept=False)
    
    # --- Initialize components for Routine "practice_prating_int" ---
    pain_text_practice = visual.TextStim(win=win, name='pain_text_practice',
        text="Additionally, you are asked to rate the electrical stimuli presented to you during the experiment.\n\nOn the first scale, rate how painful/intense you found the electrical stimuli. The scale ranges from 'not painful at all' to 'unbearably painful.'\n\nUse the arrow keys to position the blue marker at the appropriate value. Press Enter to confirm your selection and proceed with the experiment.",
        font='Arial',
        pos=(0, 0.075), height=0.035, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    practice_pain_slider = visual.RatingScale(win=win, name='practice_pain_slider', marker='triangle', size=1.0, pos=[0.0, -0.65], low=0, high=10, labels=['not painful at all', ' unbearably painful'], scale='How painful/intense did you perceive the last electrical stimulus? ', markerStart='0', showAccept=False)
    ...
    pain_text_practice_2 = visual.TextStim(win=win, name='pain_text_practice_2',
        text="On the second scale, you should also rate how unpleasant/annoying you found the electrical stimuli. This scale ranges from 'not unpleasant at all' to 'very unpleasant.'\n\nUse the arrow keys to position the blue marker at the appropriate value. Press Enter to confirm your selection and proceed with the experiment.",
        font='Arial',
        pos=(0, 0.075), height=0.035, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    practice_pain_slider_2 = visual.RatingScale(win=win, name='practice_pain_slider_2', marker='triangle', size=1.0, pos=[0.0, -0.65], low=0, high=10, labels=['not unpleasant at all', ' very unpleasant'], scale='How unpleasant/annoying did you perceive the last electrical stimulus?', markerStart='0', showAccept=False)
    
    # --- Initialize components for Routine "instr_experimentator" ---
    instr_e_text = visual.TextStim(win=win, name='instr_e_text',
        text='Your experimenter will now start the recording.\nDo you have any questions?\n\n---  Please report to the experimenter  ---\n',
        font='Arial',
        pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
        color='white', colorSpace='rgb', opacity=1, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "pain_rating_intensity" ---
    p_rating_1 = visual.RatingScale(win=win, name='p_rating_1', marker='triangle', size=1.0, pos=[0.0, -0.4], low=0, high=10, labels=['not painful at all', ' unbearably painful'], scale='How painful/intense did you perceive the last electrical stimulus?', markerStart=0.0, showAccept=False)
    
    # --- Initialize components for Routine "pain_rating_unpleasant" ---
    p_rating_2 = visual.RatingScale(win=win, name='p_rating_2', marker='triangle', size=1.0, pos=[0.0, -0.4], low=0, high=10, labels=['not unpleasant at all', ' very unpleasant'], scale='How unpleasant/annoying did you perceive the last electrical stimulus?', markerStart=0.0, showAccept=False)
    ...
    for thisFull_acq in full_acq:
        ...
        for thisAcq_rating_trial in acq_rating_trials:
            ...
            # --- Prepare to start Routine "pain_rating_intensity" ---
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('pain_rating_intensity.started', globalClock.getTime(format='float'))
            p_rating_1.reset()
            # keep track of which components have finished
            pain_rating_intensityComponents = [p_rating_1]
            for thisComponent in pain_rating_intensityComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "pain_rating_intensity" ---
            routineForceEnded = not continueRoutine
            while continueRoutine:
                # get current time
                t = routineTimer.getTime()
            ...
            # --- Ending Routine "pain_rating_intensity" ---
            for thisComponent in pain_rating_intensityComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('pain_rating_intensity.stopped', globalClock.getTime(format='float'))
            # store data for acq_rating_trials (TrialHandler)
            acq_rating_trials.addData('p_rating_1.response', p_rating_1.getRating())
            acq_rating_trials.addData('p_rating_1.rt', p_rating_1.getRT())
            # the Routine "pain_rating_intensity" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            
            # --- Prepare to start Routine "pain_rating_unpleasant" ---
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('pain_rating_unpleasant.started', globalClock.getTime(format='float'))
            p_rating_2.reset()
            # keep track of which components have finished
            pain_rating_unpleasantComponents = [p_rating_2]
            for thisComponent in pain_rating_unpleasantComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "pain_rating_unpleasant" ---
            routineForceEnded = not continueRoutine
            while continueRoutine:
                # get current time
                t = routineTimer.getTime()
            ...
            # --- Ending Routine "pain_rating_unpleasant" ---
            for thisComponent in pain_rating_unpleasantComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('pain_rating_unpleasant.stopped', globalClock.getTime(format='float'))
            # store data for acq_rating_trials (TrialHandler)
            acq_rating_trials.addData('p_rating_2.response', p_rating_2.getRating())
            acq_rating_trials.addData('p_rating_2.rt', p_rating_2.getRT())
            # the Routine "pain_rating_unpleasant" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
