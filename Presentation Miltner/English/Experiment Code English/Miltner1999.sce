...
picture {
   text {
      font_size = 18;
      caption = "Enter CS assignment ('1' or '2') and confirm by pressing <ENTER>.
			...
			Restart the experiment if you encounter an error.";};
   x = 0; y = 0;
   text {
      font_size = 18;
      caption = " ";
...
text{ caption =" "; font_size = 20; font_color = 255,255,255; transparent_color = 128,128,128; }empty_text;

text{ caption ="The scale ranges from negative to positive.
At the first extreme, the stimuli have a very negative effect on you, at the other a very positive effect.
If the stimuli have no effect on you, i.e. neither positive nor negative, 
please move the circle to the 0 in the centre.

Use the arrow keys to place the red circle on the corresponding number.
Press the space bar to confirm your selection and continue with the experiment."; font_size = 20; font_color = 255,255,255; transparent_color = 128,128,128; }practice_text;

text { caption ="How negative/positive do you feel while seeing this stimulus?"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }tv_rating1;
...
text { caption ="very negative"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }tv_rating12;
text { caption ="neutral"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }tv_rating13;
text { caption ="very positive"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }tv_rating14;
...
text{ caption ="Additionally, you are asked to rate the electrical stimuli presented to you during the experiment.
...
Use the arrow keys to place the red circle on the corresponding number.
Press the space bar to confirm your selection and continue with the experiment."; font_size = 20; font_color = 255,255,255; transparent_color = 128,128,128; }practice_text2;

text { caption ="How painful/intense did you perceive the last electrical stimulus?"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pi_rating1;
...
text { caption ="not painful at all"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pi_rating12;
#text { caption ="neutral"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pi_rating13;
text { caption ="unbearably painful"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pi_rating14;
...
text{ caption ="On the second scale, you should also rate how unpleasant/annoying you found the electrical stimuli. 
This scale ranges from 'not unpleasant at all' to 'very unpleasant.'

Use the arrow keys to place the red circle on the corresponding number.
Press the space bar to confirm your selection and continue with the experiment."; font_size = 20; font_color = 255,255,255; transparent_color = 128,128,128; }practice_text3;

text { caption ="How unpleasant/annoying did you perceive the last electrical stimulus?"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pu_rating1;
...
text { caption ="not unpleasant at all"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pu_rating12;
#text { caption ="neutral"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pu_rating13;
text { caption ="very unpleasant"; font_size = 22; font_color = 255,255,255; transparent_color = 128,128,128; }pu_rating14;
...
sub iti begin
iti_event.set_duration ( random(3000,5000) ) ; #set ITI duration to 4s without jitter
iti_trial.present () ;
end;
...
# Intro and instructions:
	instr("Welcome and thank you for participating in this experiment.\n\n\n\n---  Press the space bar to continue  ---");
	instr("For the next 30 minutes you will see different symbols.\nYour task is to focus on the fixation cross in the centre of the screen.\n\n---  Press the space bar to continue  ---");
	instr("In between, you should regularly indicate how you feel while seeing these stimuli.\nThere are no 'right' or 'wrong' answers, so please answer as honestly as possible!\n\n\n---  Press the space bar to continue  ---");

	practice_rating(); 			#practice rating slider

# Cue acquisition:
	instrvl("Your experimenter will now start the recording.\nDo you have any questions?\n\n---  Please report to the experimenter  ---");
